			...
			policy: &v1.Policy{
				Spec: v1.PolicySpec{
					OIDC: &v1.OIDC{
						...
						JWKSURI:           "https://foo.bar/certs",
						LogoutEndpoint:    "https://foo.bar/logout",
						LogoutRedirect:    "/_logout",
	...
	tests := []struct {
		...
		},
		{
			oidc: &v1.OIDC{
				...
				LogoutEndpoint:    "https://login.microsoftonline.com/dd-fff-eee-1234-9be/discovery/v2.0/logout",
				LogoutRedirect:    "/_logout",
				RedirectURI:       "/_codexch",
				ClientID:          "ff",
				ClientSecret:      "ff",
		...
		},
		{
			oidc: &v1.OIDC{
				...
				LogoutEndpoint:    "http://keycloak.default.svc.cluster.local:8080/realms/master/protocol/openid-connect/logout",
				LogoutRedirect:    "/_logout",
				RedirectURI:       "/_codexch",
				ClientID:          "bar",
				ClientSecret:      "foo",
		...
		},
		{
			oidc: &v1.OIDC{
				...
				LogoutEndpoint:    "http://127.0.0.1:8080/realms/master/protocol/openid-connect/logout",
				LogoutRedirect:    "/_logout",
				RedirectURI:       "/_codexch",
				ClientID:          "client",
				ClientSecret:      "secret",
		...
		},
		{
			...
			msg: "no logout endpoint or logout redirect",
		},
		{
			oidc: &v1.OIDC{
				AuthEndpoint:      "http://127.0.0.1:8080/realms/master/protocol/openid-connect/auth",
			...
			msg: "no logout endpoint redirect",
		},
	}
	...
	tests := []struct {
		...
		},
		{
			oidc: &v1.OIDC{
				AuthEndpoint:      "https://login.microsoftonline.com/dd-fff-eee-1234-9be/oauth2/v2.0/authorize",
				JWKSURI:           "https://login.microsoftonline.com/dd-fff-eee-1234-9be/discovery/v2.0/keys",
				LogoutEndpoint:    "https://login.microsoftonline.com/dd-fff-eee-1234-9be/oauth2/v2.0/logout",
				LogoutRedirect:    "/_logout",
				ClientID:          "ff",
				ClientSecret:      "ff",
				Scope:             "openid+profile",
		...
		},
		{
			...
			fieldPath: "oidc.logoutRedirect",
			msg:       "missing required field logout endpoint when logout redirect is set",
		},
		{
			oidc: &v1.OIDC{
				AuthEndpoint:      "https://login.microsoftonline.com/dd-fff-eee-1234-9be/oauth2/v2.0/authorize",
		...
		},
		{
			oidc: &v1.OIDC{
				...
				LogoutEndpoint:    "http://keycloak.default/",
				LogoutRedirect:    "/_logout",
				RedirectURI:       "/_codexch",
				ClientID:          "bar",
				ClientSecret:      "foo",
