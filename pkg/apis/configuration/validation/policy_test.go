	...
	tests := []struct {
		...
		},
		{
			oidc: &v1.OIDC{
				...
				LogoutEndpoint:     "http://keycloak.default.svc.cluster.local:8080/auth/realms/master/protocol/openid-connect/logout",
				RedirectPostLogout: "https://foo.com/",
				ClientID:           "bar",
				ClientSecret:       "foo",
				Scope:              "openid",
		...
		},
		{
			oidc: &v1.OIDC{
				...
				LogoutEndpoint:     "http://127.0.0.1:8080/auth/realms/master/protocol/openid-connect/logout",
				RedirectPostLogout: "https://foo.com/",
				ClientID:           "client",
				ClientSecret:       "secret",
				Scope:              "openid",
