...
func (in *APIKey) DeepCopyInto(out *APIKey) {
	*out = *in
	in.SuppliedIn.DeepCopyInto(&out.SuppliedIn)
	in.RejectCodes.DeepCopyInto(&out.RejectCodes)
	return
}
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *RejectCodes) DeepCopyInto(out *RejectCodes) {
	*out = *in
	if in.NotSupplied != nil {
		in, out := &in.NotSupplied, &out.NotSupplied
		*out = new(int)
		**out = **in
	}
	if in.NoMatch != nil {
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new RejectCodes.
func (in *RejectCodes) DeepCopy() *RejectCodes {
	if in == nil {
		return nil
	}
	out := new(RejectCodes)
