...
from settings import ALLOWED_DEPLOYMENT_TYPES, ALLOWED_IC_TYPES, ALLOWED_SERVICE_TYPES, DEPLOYMENTS, TEST_DATA, BASEDIR
...
def ingress_controller_prerequisites(cli_arguments, kube_apis, request) -> IngressControllerPrerequisites:
    ...
    create_secret_from_yaml(kube_apis.v1, namespace, f"{BASEDIR}/examples/shared-examples/default-server-secret/default-server-secret.yaml")
