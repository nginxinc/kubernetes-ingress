...
dos_pol_crd = f"{DEPLOYMENTS}/common/crds/appprotectdos.f5.com_apdospolicy.yaml"
dos_log_crd = f"{DEPLOYMENTS}/common/crds/appprotectdos.f5.com_apdoslogconfs.yaml"
dos_pol_crd_resource = f"{TEST_DATA}/dos/dos-policy.yaml"
dos_log_crd_resource = f"{TEST_DATA}/dos/dos-logconf.yaml"
...
class TestDos:
    ...
    def test_dos_sec_logs_on(
        ...
        response = requests.get(dos_setup.req_url, headers=headers, verify=False)
        print(response.text)
        wait_before_test(10)
