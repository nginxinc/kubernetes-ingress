...
|``listener`` | Sets a custom HTTP and/or HTTPS listener. Must reference the name of a listener defined in a GlobalConfiguration resource | [listener](#virtualserverlistener) | No |
