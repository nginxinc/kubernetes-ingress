...
- **RegularIngressCount** The number of Regular Ingress resources managed by the NGINX Ingress Controller.
- **MasterIngressCount** The number of Master Ingress resources managed by the NGINX Ingress Controller.
- **MinionIngressCount** The number of Minion Ingress resources managed by the NGINX Ingress Controller.
