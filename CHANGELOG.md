...
An automatically generated list of changes can be found on GitHub at: [ic-version Release](https://github.com/nginxinc/kubernetes-ingress/releases/tag/vic-version)
