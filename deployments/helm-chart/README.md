...
`controller.serviceAccount.imagePullSecrets` | Deprecated. Please use `controller.serviceAccount.imagePullSecretName` instead. The names of the secrets containing docker registry credentials. | []
